class CfgMods
{
	...
	class dcd_suck : Mod_Base
	{
		...
		picture = "\p\dcd\dcs_suck\addons\base\ui\dcd_suck_picture.paa";
		logo = "\p\dcd\dcs_suck\addons\base\ui\dcd_suck_icon.paa";
		logoSmall = "\p\dcd\dcs_suck\addons\base\ui\dcd_suck_icon.paa";
		logoOver = "\p\dcd\dcs_suck\addons\base\ui\dcd_suck_icon.paa";
